...
const BookingSection = () => {
        ...
        <div className="container mx-auto px-3 sm:px-4">
          <div className="max-w-2xl mx-auto text-center">
            <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 shadow-2xl border border-blue-100">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3 sm:mb-4">Appointment Booked Successfully!</h2>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg sm:rounded-2xl p-3 sm:p-4 mb-6">
                <p className="text-yellow-800 text-xs sm:text-sm flex items-start">
                  ...
                  <span><strong>Check your inbox:</strong> Please check your email (including spam folder) for confirmation and portal access details.</span>
                </p>
              </div>
  ...
  return (
    <section id="booking" className="py-8 sm:py-12 md:py-16 lg:py-20 bg-gradient-to-br from-gray-50 to-blue-50">
          ...
          <div className="space-y-6 sm:space-y-7 md:space-y-8">
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl md:rounded-3xl p-5 sm:p-6 md:p-8 shadow-lg border border-blue-100">
              <div className="flex items-center space-x-2 sm:space-x-3 mb-3 sm:mb-4">
                ...
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900">Patient Portal Access</h3>
              </div>
              <div className="space-y-4">
            ...
            <div className="bg-gradient-to-br from-red-500 to-red-600 rounded-xl sm:rounded-2xl md:rounded-3xl p-5 sm:p-6 md:p-8 text-white relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-3 sm:mb-4">Emergency Care</h3>

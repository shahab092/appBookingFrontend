...
import { FaCalendarCheck, FaUser, FaPhone, FaEnvelope, FaClock, FaStethoscope, FaCheckCircle, FaVideo, FaClinicMedical, FaHome, FaUserCircle, FaLock, FaInfoCircle } from 'react-icons/fa';
...
const BookingSection = () => {
  ...
  const doctors = [
    { id: 1, name: 'Dr. Sarah Johnson', specialty: 'Clinical Psychiatrist', available: ['online', 'in-clinic'] },
    { id: 2, name: 'Dr. Michael Chen', specialty: 'Child Psychiatrist', available: ['in-clinic'] },
    { id: 3, name: 'Dr. Emily Davis', specialty: 'Therapy Specialist', available: ['online', 'in-clinic'] },
    { id: 4, name: 'Dr. Robert Wilson', specialty: 'Neurologist', available: ['in-clinic'] },
    { id: 5, name: 'Dr. Lisa Brown', specialty: 'Counseling Psychologist', available: ['online'] }
  ];
          ...
          <div className="max-w-2xl mx-auto text-center">
            <div className="bg-white rounded-3xl p-12 shadow-2xl border border-blue-100">
              ...
              <p className="text-gray-600 text-lg mb-6">
                Thank you for choosing PsycheCare. We have received your booking request.
              </p>

              <div className="bg-blue-50 rounded-2xl p-6 mb-6 text-left">
                <h3 className="font-semibold text-gray-900 mb-4 flex items-center">
                  <FaInfoCircle className="text-[#2e76ad] mr-2" />
                  Important Next Steps:
                </h3>
                <div className="space-y-3">
                  <p className="text-gray-600 flex items-start">
                    <FaCheckCircle className="text-green-500 mt-1 mr-2 flex-shrink-0" />
                    <span>We will send a confirmation email to <strong>{formData.email}</strong> within 15 minutes</span>
                  </p>
                  <p className="text-gray-600 flex items-start">
                    <FaCheckCircle className="text-green-500 mt-1 mr-2 flex-shrink-0" />
                    <span>A patient portal account will be created using this email</span>
                  </p>
                  <p className="text-gray-600 flex items-start">
                    <FaCheckCircle className="text-green-500 mt-1 mr-2 flex-shrink-0" />
                    <span>Use the portal to track appointments, view reports, and message your doctor</span>
                  </p>
                </div>
              </div>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-2xl p-4 mb-6">
                <p className="text-yellow-800 text-sm flex items-center">
                  ...
                  <strong>Check your inbox:</strong> Please check your email (including spam folder) for confirmation and portal access details.
                </p>
              </div>

              <button
                onClick={() => setIsSubmitted(false)}
                className="bg-[#2e76ad] hover:bg-[#256399] text-white px-8 py-4 rounded-xl font-bold transition-all duration-200 transform hover:scale-105 shadow-lg"
              >
  ...
  return (
    <section id="booking" className="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-gray-50 to-blue-50">
      <div className="container mx-auto px-4 sm:px-6">
        {/* Login Prompt - Show if not authenticated */}
        {!isAuthenticated && (
          <div className="max-w-4xl mx-auto mb-8 sm:mb-10 md:mb-12 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-2xl sm:rounded-3xl p-6 sm:p-7 md:p-8 text-white shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex flex-col lg:flex-row items-center justify-between gap-4 sm:gap-6">
                <div className="flex-1 w-full lg:w-auto">
                  <h3 className="text-2xl sm:text-2.5xl md:text-3xl font-bold mb-2">Ready to Book Your Appointment?</h3>
                  <p className="text-blue-100 text-base sm:text-lg mb-4">
                    Sign in to access our appointment booking system and manage your healthcare journey with ease.
                  </p>
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-4 sm:pt-5 md:pt-6">
                    ...
                    <button 
                      className="border-2 border-white text-white px-6 sm:px-7 md:px-8 py-3 sm:py-3.5 md:py-4 rounded-xl sm:rounded-2xl font-bold text-sm sm:text-base md:text-lg hover:bg-white/10 transition-all duration-200 flex items-center justify-center space-x-2 w-full sm:w-auto"
                    >
                      <FaPhone size={18} className="sm:w-5 sm:h-5" />
                      <span className="text-sm sm:text-base md:text-lg">Call: +1-555-123-4567</span>
                    </button>
                  </div>
                </div>
        ...
        <div className="text-center mb-10 sm:mb-12 md:mb-16">
          <div className="inline-flex items-center space-x-2 bg-[#2e76ad]/10 text-[#2e76ad] px-4 sm:px-5 md:px-6 py-2 sm:py-2.5 md:py-3 rounded-full font-semibold mb-4 sm:mb-5 md:mb-6 shadow-lg text-sm sm:text-base">
            <FaCalendarCheck className="w-4 h-4 sm:w-5 sm:h-5" />
            <span>Book Your Appointment</span>
          </div>
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4 sm:mb-5 md:mb-6 px-2">
            Schedule Your <span className="text-[#2e76ad]">Care Journey</span>
          </h2>
          <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed px-4">
            Choose your preferred consultation type and book your appointment in just a few clicks.
          </p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 max-w-6xl mx-auto">
          {/* Booking Form */}
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl p-5 sm:p-6 md:p-8 border border-blue-100 relative overflow-hidden">
            {/* Decorative Elements */}
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-600 mb-6 sm:mb-7 md:mb-8 text-sm sm:text-base">Fill in your details to schedule your visit</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 border border-blue-200">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                    {/* In-Clinic Option */}
                    <label className={`cursor-pointer transition-all duration-300 ${formData.consultationType === 'in-clinic'
                        ? 'transform scale-105'
                        : 'hover:scale-102'
                      }`}>
                      <input
                        ...
                        className="hidden"
                      />
                      <div className={`border-2 rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 text-center transition-all duration-300 ${formData.consultationType === 'in-clinic'
                          ? 'border-[#2e76ad] bg-white shadow-lg ring-2 ring-[#2e76ad]/20'
                          : 'border-gray-300 bg-white hover:border-[#2e76ad] hover:shadow-md'
                        }`}>
                        <div className={`w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full mx-auto mb-3 sm:mb-4 flex items-center justify-center ${formData.consultationType === 'in-clinic'
                            ? 'bg-[#2e76ad] text-white'
                            : 'bg-gray-100 text-gray-400'
                          }`}>
                          <FaClinicMedical className="text-xl sm:text-2xl" />
                        </div>
                        <h4 className="font-bold text-gray-900 mb-1 sm:mb-2 text-sm sm:text-base">In-Clinic Visit</h4>
                        <p className="text-xs sm:text-sm text-gray-600 mb-2 sm:mb-3">Visit our hospital for comprehensive care</p>
                    ...
                    {/* Online Option */}
                    <label className={`cursor-pointer transition-all duration-300 ${formData.consultationType === 'online'
                        ? 'transform scale-105'
                        : 'hover:scale-102'
                      }`}>
                      <input
                        ...
                        className="hidden"
                      />
                      <div className={`border-2 rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 text-center transition-all duration-300 ${formData.consultationType === 'online'
                          ? 'border-[#2e76ad] bg-white shadow-lg ring-2 ring-[#2e76ad]/20'
                          : 'border-gray-300 bg-white hover:border-[#2e76ad] hover:shadow-md'
                        }`}>
                        <div className={`w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full mx-auto mb-3 sm:mb-4 flex items-center justify-center ${formData.consultationType === 'online'
                            ? 'bg-[#2e76ad] text-white'
                            : 'bg-gray-100 text-gray-400'
                          }`}>
                          <FaVideo className="text-xl sm:text-2xl" />
                        </div>
                        <h4 className="font-bold text-gray-900 mb-1 sm:mb-2 text-sm sm:text-base">Video Consultation</h4>
                        <p className="text-xs sm:text-sm text-gray-600 mb-2 sm:mb-3">Online consultation from anywhere</p>
                        <div className="text-xs text-green-600 font-semibold bg-green-50 py-0.5 sm:py-1 px-2 sm:px-3 rounded-full">
                          Convenient & safe
                        </div>
                      </div>
                ...
                <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 border border-blue-200">
                  ...
                  <div className="mb-4">
                      ...
                      >
                        ...
                        {getAvailableDoctors().map((doctor) => (
                          <option key={doctor.id} value={doctor.name}>
                            ...
                            {doctor.available.includes('online') && doctor.available.includes('in-clinic') ? ' (Online & In-Clinic)' :
                              doctor.available.includes('online') ? ' (Online Only)' : ' (In-Clinic Only)'}
                          </option>
                        ))}
                      </select>
                      <div className="absolute right-4 top-1/2 transform -translate-y-1/2 pointer-events-none">
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                      Only doctors available for {formData.consultationType === 'online' ? 'online' : 'in-clinic'} consultation are shown
                    </p>
                  </div>
                ...
                >
                  ...
                  <span className="text-lg">
                    Book {formData.consultationType === 'online' ? 'Video' : 'In-Clinic'} Appointment
                  </span>
                </button>
              </form>
            </div>
          ...
          <div className="space-y-8">
            {/* Consultation Info */}
            <div className="bg-gradient-to-br from-[#2e76ad] to-[#3a8ccc] rounded-3xl p-8 text-white relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -translate-y-16 translate-x-16"></div>
              <div className="relative z-10">
                <h3 className="text-2xl font-bold mb-6">
                  {formData.consultationType === 'online' ? 'Video Consultation' : 'In-Clinic Visit'}
                </h3>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-4 bg-white/10 rounded-2xl p-4">
                      ...
                      <div>
                        ...
                        <p className="text-blue-100 text-sm">Private and encrypted consultation</p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-4 bg-white/10 rounded-2xl p-4">
                      <div className="bg-white/20 p-3 rounded-xl">
                      ...
                      <div>
                        ...
                        <p className="text-blue-100 text-sm">Comfortable and convenient</p>
                      </div>
                    </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-4 bg-white/10 rounded-2xl p-4">
                      ...
                      <div>
                        ...
                        <p className="text-blue-100 text-sm">Full physical examination available</p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-4 bg-white/10 rounded-2xl p-4">
                      <div className="bg-white/20 p-3 rounded-xl">
                      ...
                      <div>
                        ...
                        <p className="text-blue-100 text-sm">Face-to-face with specialists</p>
                      </div>
                    </div>
                    <div className="bg-white/10 rounded-2xl p-4 mt-4">
                      <p className="text-sm font-semibold mb-2">What to Bring:</p>
                      <ul className="text-blue-100 text-sm space-y-1">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg border border-blue-100">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h3 className="text-2xl font-bold text-gray-900">Patient Portal Access</h3>
              </div>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <FaCheckCircle className="text-green-500 mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-gray-900">Automatic Profile Creation</p>
                    <p className="text-gray-600 text-sm">Your patient portal account will be created using the email you provide</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <FaCheckCircle className="text-green-500 mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-gray-900">Follow-up & Tracking</p>
                    <p className="text-gray-600 text-sm">Access test results, appointment history, and doctor messages</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <FaCheckCircle className="text-green-500 mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-gray-900">Secure Communication</p>
                    <p className="text-gray-600 text-sm">Message your doctor directly through the portal</p>
                  </div>
                </div>
              </div>
              <div className="mt-6 bg-blue-50 rounded-2xl p-4 border border-blue-200">
                <p className="text-sm text-blue-800">
                  <strong>Note:</strong> Check your email after booking for portal login instructions. Make sure to use a reachable email address you check regularly.
                </p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-red-500 to-red-600 rounded-3xl p-8 text-white relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="mb-6 text-red-100 text-lg">
                  Need immediate medical attention? Our emergency services are available 24/7.
                </p>
                <button className="w-full bg-white text-red-600 font-bold py-4 px-6 rounded-xl hover:bg-red-50 transition-all duration-200 transform hover:scale-105 flex items-center justify-center space-x-3 shadow-lg">
                  <FaPhone size={20} />
                  <span className="text-lg">Call Emergency: 1-800-HELP</span>
                </button>
              </div>
            </div>
          </div>

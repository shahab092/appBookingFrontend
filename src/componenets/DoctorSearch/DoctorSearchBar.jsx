...
const DoctorSearchBar = ({
  ...
  return (
    ...
    >
          ...
          {showSuggestions && suggestions.length > 0 && (
            <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-xl shadow-2xl border border-gray-100 z-[100] overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
              {suggestions.map((doctor) => (
                ...
                >
                  <div className="w-10 h-10 rounded-full overflow-hidden mr-3 border border-gray-100 shrink-0 group-hover:border-primary transition-colors">
                    <img
                      src={doctor.image}
                      alt={doctor.name}
      ...
      <div className="flex flex-wrap items-center gap-2 mt-2.5 pt-2.5 border-t border-gray-50 font-medium">
